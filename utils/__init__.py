...
from utils.experiment import run_experiment, run_foraging_experiment
from utils.plotting   import smooth, plot_with_ci, draw_simplex, plot_simplex_trajectory, summary_table
from utils.metrics    import dist_to_ne, policy_entropy, policy_to_simplex
...
__all__ = [
    ...
    # metrics
    "dist_to_ne", "policy_entropy", "policy_to_simplex",
    # io
